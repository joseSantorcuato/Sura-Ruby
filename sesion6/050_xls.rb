...
hoja.column(3).default_format = formato_moneda #formatea la columna 1, b como moneda
hoja.column(2).default_format = formato_fecha  #formatea la columna 2, c como fecha

hoja[0,0] = Spreadsheet::Link.new 'http://www.arselectronicachile.blogspot.com', 'Ir a AEC'



hoja.row(1).push "Columna 1", 9990, DateTime.now #fuerza a la primera columna a llevar el texto Columna 1
